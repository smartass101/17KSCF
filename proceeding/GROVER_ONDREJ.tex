...
\textwidth=17.3truecm \hoffset=0.55truecm \textheight=25truecm
...
This was achieved by constructing several U-turns resulting in a ``trombone-like'' design.
...
\begin{figure}
    \begin{center}
        \includegraphics[width=.5\textwidth]{data.eps}
    \end{center}
...
Ing. Vojtěch Svoboda \dots project supervisor%I wouldlike to thank... 
%------------------------------------
