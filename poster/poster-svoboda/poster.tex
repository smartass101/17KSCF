...
\end{itemize}
 ...
 {
 %info+schema
 The refractive index of \textcolor{purple}{plasma} $n$ is dependent on the electron density $n_e$. Therefore, a microwave beam with $f \sim 75$ GHz \textcolor{green}{probing the plasma} undergoes a phase shift $\Delta \varphi$ which is directly proportional to $n_e$
%vzorec
\begin{itemize}
