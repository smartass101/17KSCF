...
\end{multicols}
 ...
 {
The amplified signal is digitized with a sampling frequency of 25 MHz and then processed on a computer. The data sample is then fitted to a function $f(t)=A \cdot \sin (2\pi\cdot 5e5 t + \varphi)$ and $\varphi$ is extracted and normalized. 
...
A possible explanation is that there is a coupling of the chamber and the diagnostic hardware through the waveguide system which results in a change of $f_{mod}$ and/or $\Delta f$.
     \begin{itemize}
         ...
         \item a change in $\Delta f$ would result only in a change of the frequency of the amplified signal
     \end{itemize}
